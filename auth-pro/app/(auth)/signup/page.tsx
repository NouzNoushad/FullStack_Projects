                ...
                <Card className='w-[400px] mx-auto'>
                    ...
                    <CardContent className="mt-8">
                        <form className="space-y-2">
                            <div>
                                <input type="name" name="name" placeholder="Name" className="form-input" />
                            </div>
                            <div>
                            ...
                            <div className="pt-10">
                                <button type="submit" className="w-full bg-slate-800 text-white font-[500] text-[0.9rem] py-2 rounded-sm flex flex-row items-center justify-center gap-[10px]">{'Signup'}</button>
                            </div>
                        </form>
