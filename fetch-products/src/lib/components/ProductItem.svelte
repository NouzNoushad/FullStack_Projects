...
<div class="border border-black rounded-md shadow-lg px-5 py-5 flex flex-col">
	<div class="grow">
	...
	<button class="mt-5 bg-green-500 w-full rounded-md px-2 py-2 text-white font-[500] space-x-3">
